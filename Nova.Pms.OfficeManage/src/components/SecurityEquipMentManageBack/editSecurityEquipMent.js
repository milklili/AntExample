...
import { Table, Pagination, Popconfirm, Modal,Alert, Button, Form, Input, Menu, Dropdown, Icon, DatePicker, Upload, message, Row, Col, Select } from 'antd';
    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                this.props.dispatch({
                    type: "editSecurityEquipMent/editSecurityEquipMent",
                    payload: values
                });
            } else {
...
const WrappeEditSecurityEquipment = Form.create({
    ...
    onFieldsChange(props, changedFields) {
        ...
        props.dispatch({
            type: "editSecurityEquipMent/changeField",
            payload: {
                key,
...
function mapStateToProps(state) {
    return {
        loading: state.loading.models.editSecurityEquipMent,
        ...state.editSecurityEquipMent
    };
}

export default connect(mapStateToProps)(WrappeEditSecurityEquipment);
