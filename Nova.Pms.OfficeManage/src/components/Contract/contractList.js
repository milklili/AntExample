...
function ContractList({ dispatch, list: dataSource, loading, total, page: current, filterStr}) {
    ...
    const columns = [
        {
            ...
            render: (text, record) => (
                <span className={styles.operation}>
                    ...
                    <Popconfirm title="确定要删除该合同吗?" onConfirm={deleteHandler.bind(null, record.id)}>
                        <a href="">删除</a>
                    </Popconfirm>
                </span>
            ),
        ...
        <div className={styles.normal}>
            <div>
                <div className={styles.create}>
                    <Link to="/createContract"><Button type="primary">新建合同</Button></Link>
                    <Search
                        placeholder="Search"
