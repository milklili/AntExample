...
import { Table, Pagination, Popconfirm, Button, Input, Alert, Form, Card, Row, Col, Select, DatePicker, Icon } from 'antd';
import { routerRedux, Link } from 'dva/router';
import styles from './Meeting.css';
import { PAGE_SIZE } from '../../constants';

const Meeting = ({ dispatch, total, loading, list: dataSource, page: current, filterStr, pageSize})=>{
            ...
            const columns = [
                {
                    ...
                    width: '5%',
                    render: (text, record, index) => (
                        record.createDate != null ? (new Date(record.createDate)).toLocaleDateString() : null
                    )
                },{
                    title: '备注',
                    dataIndex: 'remark',
            ...
            return(
                    <div>
                        <div className={styles.ListButton}>
                            <Row>
                                <Col span={4}><Link to="/createMeeting"><Button type="primary">新建</Button></Link></Col>
