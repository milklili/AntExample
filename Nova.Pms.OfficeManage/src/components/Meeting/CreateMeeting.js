...
class MeetingForm extends React.Component {
    ...
    selectRegion = (value) => {
        this.props.dispatch({
            type: "createMeeting/selectRegion",
            payload: value
        });
    }
...
function mapStateToProps(state) {
    const { regions, meetingCategorys, departments, staffs, formData } = state.createMeeting;
    return {
        regions,
        meetingCategorys,
        departments,
...
export default connect(mapStateToProps)(WrappedMeetingCreateForm);
