...
import { Table, Pagination, Popconfirm,Alert, Modal, Button, Form, Input, Menu, Dropdown, Icon, DatePicker, Upload, message, Row, Col, Select } from 'antd';
...
class WorkingPlanForm extends React.Component {
    ...
    render() {
        ...
        const isSelectRegion = this.props.workingPlan.regionId != null && this.props.workingPlan.regionId > 0;
                    ...
                    <Row gutter={8}>
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="部门">
                                ...
                                })(<Select disabled={!isSelectRegion}
                                    placeholder="请选择"
                                    >{departmentOptions}</Select>)}
                            </FormItem>
                        </Col>
                        <Col span={12}>   
                        ...
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="计划名称">
                                {getFieldDecorator('name', {                                   
                                    rules: [{ type:"string",max:50,required: true, message: '请输入计划名称,不超过50个字' }],
                    ...
                    <Row gutter={8}>
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="计划类别">
                                ...
                                })(<Select placeholder="请选择">{officeManagementCategoryOptions}</Select>)}
                            </FormItem>                          
                        </Col>
                        <Col span={12}>
                        ...
                        <Col span={12}>
                            <Row gutter={8}>
                                <FormItem {...formItemLayout} label="召集人">
                                    ...
                                    })(<Select disabled={!isSelectRegion} placeholder="请选择">{staffOptions}</Select>)}
                                </FormItem> 
                            </Row>
                            <Row gutter={8}>
                            ...
                            <Row gutter={8}>
                                <FormItem {...formItemLayout} label="参加人员">
                                    ...
                                    })(<Select mode="multiple" disabled={!isSelectRegion} placeholder="请选择">{staffOptions}</Select>)}
                                </FormItem>
                            </Row>
                            <Row gutter={8}>
                        ...
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="计划内容">
                                {getFieldDecorator('planContent', {
                                    rules: [{ type:"string",max:300,required: true, message: '请填写计划内容!' }],
...
function mapStateToProps(state) {
    const { workingPlan, regionList, departmentList, staffList, officeManagementCategoryList} = state.createWorkingPlan;
    return {
        workingPlan,
        regionList,
        departmentList,
