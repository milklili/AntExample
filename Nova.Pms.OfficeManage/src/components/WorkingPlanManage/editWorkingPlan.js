...
import { Table, Pagination, Popconfirm, Modal, Button, Form, Input, Menu, Dropdown, Icon, DatePicker,Alert , Upload, message, Row, Col, Select } from 'antd';
...
function mapStateToProps(state) {
    const { workingPlan, regionList, departmentList, staffList, officeManagementCategoryList } = state.editWorkingPlan;
    return {
        workingPlan,
        regionList,
        departmentList,
