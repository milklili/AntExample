...
import { Table, Pagination, Alert, Popconfirm, Modal, Button, Form, Input, Menu, Dropdown, Icon, DatePicker, Upload, message, Row, Col, Select } from 'antd';
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="状态">
                                {getFieldDecorator('state', {
                                    initialValue: (workingPlan != null && workingPlan.state != null) ? workingPlan.state : null,
                                })(
                                    <Select
                                        mode="combobox "
                                        placeholder="请选择"
                        ...
                        <Col span={24}>
                            <FormItem  {...formItemLayout} label="完成情况">
                                {getFieldDecorator('completion', {
                                   ...
                                   initialValue: workingPlan != null ? workingPlan.completion : null,
...
function WorkingPlanList({
            ...
            const menu = (
                <Menu onClick={this.handleMenuClick}>
                    <Menu.Item key="0">
                        ...
                        <Popconfirm title="确定要删除该工作计划吗?" onConfirm={this.deleteHandler.bind(this, [recordId])}>
                            <a >删除</a>
                        </Popconfirm>
                    </Menu.Item>
                    <Menu.Item key="1">
                    ...
                    <Menu.Item key="2">
                        <Popconfirm title="确定要审核该工作计划吗?" onConfirm={this.reviewHandler.bind(this, [recordId])}>
                            <a >审核</a>
                        </Popconfirm>
                    </Menu.Item>
                    <Menu.Item key="3">
                        <Popconfirm title="确定要撤销审核该工作计划吗?" onConfirm={this.cancellationAuditHandler.bind(this, [recordId])}>
                            <a >撤销审核</a>
                        </Popconfirm>
                    </Menu.Item>
                </Menu>
    ...
    class ChangeWorkingPlanState extends React.Component {       
        ...
        render() {
            return (
                <span>
                    <a onClick={this.showModal} style={{ color: "rgba(0, 0, 0, 0.65)" }}>更改状态</a>
                    {(<ChangeStateForm workingPlan={this.props.workingPlan}
    ...
    class WorkingPlanListForm extends React.Component {
        ...
        render() {
            ...
            review = review.filter(function (n) { return n != undefined });
            const reviewLength = review.length > 0;

            let cancelReview = selectedRows.map(function (element) {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    width: 120,
                    render: (text, record) => (
                        record.startDate != null ? (new Date(record.startDate)).toLocaleDateString() : null
                    ),
                },
                {
                    title: "计划结束时间",
                    ...
                    width: 120,
                    render: (text, record) => (
                        record.endDate != null ? (new Date(record.endDate)).toLocaleDateString() : null
                    ),
                },
                {
                    title: "召集人",
                ...
                },
                {
                    ...
                    width: 120,
                    render: (text, record) => (
                        record.actualStartDate != null ? (new Date(record.actualStartDate)).toLocaleDateString() : null
                    ),
                },
                {
                    title: "实际结束时间",
                    ...
                    width: 120,
                    render: (text, record) => (
                        record.actualEndDate != null ? (new Date(record.actualEndDate)).toLocaleDateString() : null
                    ),
                },
                {
                    title: "完成情况",
                ...
                },
                {
                    ...
                    width: 200,
                    render: (text, record) => (
                        record.createDate != null ? (new Date(record.createDate)).toLocaleString() : null
                    ),
                },
                {
                    title: "审核状态",
                    ...
                    width: 120,
                    render: (text, record) => (
                        record.auditState == true ? "已审核" : "未审核"
                    ),
                ...
                },
                {
                    ...
                    width: 200,
                    render: (text, record) => (
                        record.auditDate != null ? (new Date(record.auditDate)).toLocaleString() : null
                    ),
                },
                                            ...
                                            <Row gutter={50}>
                                                ...
                                                <Col span={8}>
                                                    <FormItem {...formItemLayout} label="计划类别">
                                                        {getFieldDecorator('workingPlanType', {
                                            ...
                                            <Row gutter={50}>
                                                <Col span={8}>
                                                    <FormItem {...formItemLayout} label="召集人">
                                                        {getFieldDecorator('convenorName', {
