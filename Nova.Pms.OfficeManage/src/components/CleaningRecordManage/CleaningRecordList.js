...
const AddCleaningRecordForm = Form.create()(
    (props) => {
        const { visible, onCancel, onCreate, form, selectRegion, dispatch, regionList, staffList, cleaningAreaList, cleaningRecord, isAddOrEdit } = props;
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="项目名称" >
                                {getFieldDecorator('name', {
                                    rules: [{ type: "string", required: isAddOrEdit, max: 30, message: "请正确输入项目名称，最大长度为30" }]     
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="计划完成时间" >
                                {getFieldDecorator('completeDate', {
                                    ...
                                    getValueProps: value => {
                                        if (!(value)) {
                                            cleaningRecord.completeDate = moment(new Date(), 'YYYY-MM-DD');
                                        }
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="实际完成时间" >
                                {getFieldDecorator('actualCompleteDate', {
                                    ...
                                    getValueProps: value => {
                                        if (!(value)) {
                                            cleaningRecord.actualCompleteDate = moment(new Date(), 'YYYY-MM-DD');
                                        }
                                        return { value: value ? moment(value) : moment(new Date(), 'YYYY-MM-DD') };
                                    }
                                })(<DatePicker style={{ width: '100%' }}
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="具体内容" >
                                {getFieldDecorator('content', {
                                    rules: [{ required: isAddOrEdit, type: "string", max: 120, message: "请正确输入具体内容，最大长度为120" }]   
                                })(<Input placeholder="请输入" disabled={!isAddOrEdit}/>)}
                            </FormItem>
                        </Col>
                    </Row>
...
function CleaningRecordList({
    ...
    class AddCleaningRecord extends React.Component {
        ...
        showModal = () => {
            ...
            var cleaningAreaList = this.props.cleaningAreaList.map(function (x) {
        ...
        handleCreate = () => {
            ...
            form.validateFields((err, values) => {
                ...
                this.setState({ visible: false, cleaningRecord: this.props.cleaningRecord });
            });
        ...
        render() {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    width: 120,
                    render: (text, record) => (
                        record.completeDate != null ? (new Date(record.completeDate)).toLocaleDateString() : null
                    ),
                },
                {
                    title: "实际完成时间",
                    ...
                    width: 120,
                    render: (text, record) => (
                        record.actualCompleteDate != null ? (new Date(record.actualCompleteDate)).toLocaleDateString() : null
                    ),
                },
                {
                    title: "项目类型",
                ...
                },
                {
                    ...
                    render: (text, record) =>
                        <span>
                            ...
                            />
                            &nbsp;                                                       
                            <Popconfirm title="确定要删除该保洁记录吗?" onConfirm={this.deleteCleaningRecord.bind(null, [record.id])}>
                                <a >删除</a>
                            </Popconfirm>
                        </span>
                }
                ...
                <div className={styles.normal}>
                    ...
                    <Row gutter={10} >
                            <Col span={8}>
                                ...
                                />
                                <Popconfirm title="确定要删除该保洁记录吗?" onConfirm={this.deleteCleaningRecord.bind(this, selectedRowKeys)}>
