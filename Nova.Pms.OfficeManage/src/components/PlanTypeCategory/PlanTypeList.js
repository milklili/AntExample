...
function PlanTypeList({ dispatch, list: dataSource, loading, total, page: current, filterStr, pageSize}) {
                ...
                <div className={styles.normal}>
                    <div>
                        <div className={styles.ListButton}>
                            <Link to="/createPlanType"><Button type="primary">新建</Button></Link>
                            <Button type="primary" onClick={this.editCategory.bind(this, selectedRowKeys[0])} disabled={!isEditCategory}>编辑</Button>
                            <Popconfirm title="确定要删除该计划类别吗?" onConfirm={this.deleteHandler.bind(this, selectedRowKeys)}>
