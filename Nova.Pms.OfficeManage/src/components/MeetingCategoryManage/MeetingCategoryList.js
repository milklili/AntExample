...
import { Table, Pagination, Popconfirm, Button, Input, Alert,Tooltip   } from 'antd';
import { routerRedux, Link } from 'dva/router';
import styles from './MeetingCategoryList.css';
import { PAGE_SIZE } from '../../constants';

function MeetingCategoryList({ dispatch, list: dataSource, loading, total, page: current, filterStr,pageSize}) {
                ...
                <div className={styles.normal}>
                    <div>
                        <div className={styles.ListButton}>
                            <Link to="/createMeetingCategory"><Button type="primary">新建</Button></Link>
                            <Button type="primary" onClick={this.editCategory.bind(this, selectedRowKeys[0])} disabled={!isEditCategory}>编辑</Button>
                            <Popconfirm title="确定要删除该会议类别吗?" onConfirm={this.deleteHandler.bind(this, selectedRowKeys)}>
