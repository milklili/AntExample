            ...
            const menu = (
                <Menu>
                    ...
                    <Menu.Item key="cancelAudit">
                        <a onClick={this.cancelAudit.bind(null, ids, this.props.rowData)}>撤销审核</a>
                    </Menu.Item>
                </Menu>
            );
            return (
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record, index) => (
                record.fileDate != null ? (new Date(record.fileDate)).toLocaleString() : null              
            )
        },
        {
            title: "归档人",
        ...
        },
        {
            ...
            width: 120,
            render: (text, record, index) => (
                record.auditState ? <span><Badge status="success" />已审核</span> : <span><Badge status="default" />未审核</span>
            )
        },
        {
            title: "审核人",
    ...
    class Document extends React.Component {
        ...
        render() {
            ...
            if (seniorSearchData.documentCategoryName != null) {
                seniorSearchValues +=
                    "文档类别: " + seniorSearchData.documentCategoryName + "; ";
            }
