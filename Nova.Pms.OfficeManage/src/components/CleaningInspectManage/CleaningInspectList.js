                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="检查时间" >
                                {getFieldDecorator('inspectDate', {
                                    ...
                                    getValueProps: value => {
                                        if (!(value)) {
                                            cleaningInspect.inspectDate = moment(new Date(), 'YYYY-MM-DD');
                                        }
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="检查情况" >
                                {getFieldDecorator('content', {
                                    rules: [{ type: "string", required: isAddOrEdit, max: 120, message: "请正确输入检查情况，最大长度为120" }]     
                                })(<Input type="textarea" placeholder="请输入" disabled={!isAddOrEdit} rows={2}/>)}
                            </FormItem>
                        </Col>
                    </Row>
    ...
    class AddCleaningInspect extends React.Component {
        ...
        handleCreate = () => {
            ...
            form.validateFields((err, values) => {
                ...
                this.setState({ visible: false, cleaningInspect: this.props.cleaningInspect });
            });
        ...
        handleFormChange = (changedFields) => {
            ...
            if (key == "regionId") {
                data = { cleaningAreaId: null, leadId: null, rummagerId:null, [key]: value };
            }
        ...
        render() {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    width: 150,
                    render: (text, Inspect) => (
                        Inspect.inspectDate != null ? (new Date(Inspect.inspectDate)).toLocaleDateString() : null
                    ),
                },
                {
                    title: "检查情况",
                ...
                },
                {
                    ...
                    render: (text, Inspect) =>
                        <span>
                            ...
                            />
                            &nbsp;                                                       
                            <Popconfirm title="确定要删除该保洁检查吗?" onConfirm={this.deleteCleaningInspect.bind(null, [Inspect.id])}>
                                <a >删除</a>
                            </Popconfirm>
                        </span>
                }
                    ...
                    <Row gutter={10} >
                            <Col span={8}>
                                ...
                                <AddCleaningInspect
                                    ...
                                    cleaningInspect={cleaningInspect}
                                />
                                <Popconfirm title="确定要删除该保洁检查吗?" onConfirm={this.deleteCleaningInspect.bind(this, selectedRowKeys)}>
