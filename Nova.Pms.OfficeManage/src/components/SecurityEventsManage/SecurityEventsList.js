...
const AddSecurityEventsForm = Form.create()(
    (props) => {
        const { visible, onCancel, onCreate, form, dispatch, regionList, securityEvents,isAddOrEdit } = props;
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="事件名称" >
                                {getFieldDecorator('name', {
                                    rules: [{ type: "string", required: isAddOrEdit, max: 30, message: "请输入事件名称，30个字以内" }] 
                        ...
                        <Col span={24}>
                            <FormItem  {...formItemLayout} label="责任人">
                                {getFieldDecorator('responsibilityPersonId', {                         
                                    rules: [{ type: "string", required: isAddOrEdit, max: 30, message: "请输入责任人，30个字以内" }]
                                })(<Input disabled={!isAddOrEdit}/>)}                            
                            </FormItem>
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="处理人" >
                                {getFieldDecorator('handlePersonId', {
                                    rules: [{ type: "string", required: isAddOrEdit, max: 30, message: "请输入处理人,30个字以内" }]
                                })(<Input disabled={!isAddOrEdit}/>)}
                            </FormItem>
                        </Col>
                    </Row>
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="发生地点" >
                                {getFieldDecorator('occurrencePlace', {
                                    rules: [{ type: "string", max: 60, required: isAddOrEdit, message: "请输入发生地点,60个字以内" }]
                                })(<Input disabled={!isAddOrEdit}/>)}
                            </FormItem>
                        </Col>
                    </Row>
                        ...
                        <Col span={24}>
                            <FormItem  {...formItemLayout} label="具体内容">
                                {getFieldDecorator('content', {
                                    rules: [{ type: "string", max: 80, required: isAddOrEdit, message: "请输入具体内容,80个字以内" }]
                                })(<Input disabled={!isAddOrEdit}/>)}
                            </FormItem>
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="处理结果" >
                                {getFieldDecorator('result', {
                                    rules: [{ type: "string", max: 80,message: "请正确输入处理结果,80个字以内" }]
                                })(<Input disabled={!isAddOrEdit}/>)}
                            </FormItem>
                        </Col>
                    </Row>
        ...
        render() {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    width: 200,
                    render: (text, record) => (
                        record.occurrenceDateTime != null ? (new Date(record.occurrenceDateTime)).toLocaleString() : null
                    ),
                },
                {
                    title: "发生地点",
                ...
                },            
                {
                    ...
                    render: (text, record) =>
                        <span>
                            ...
                            />
                            &nbsp;                                                       
                            <Popconfirm title="确定要删除该安防事件记录吗?" onConfirm={this.deleteSecurityEvents.bind(null, [record.id])}>
                                <a >删除</a>
                            </Popconfirm>
                        </span>
                }
                ...
                <div className={styles.normal}>
                    ...
                    <Row gutter={10} >
                            <Col span={8}>
                                ...
                                />
                                <Popconfirm title="确定要删除该安防事件记录吗?" onConfirm={this.deleteSecurityEvents.bind(this, selectedRowKeys)}>
