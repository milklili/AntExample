...
const EditInitiatedForm = Form.create()(
    (props) => {
        const { visible, onCancel, onCreate, form, dispatch, uploadAttachments, uploadPictures, onSendIdChange, onSendIdDeselect,onApprovalIdDeselect, onApprovalIdChange, regionList,selectRegion, staffList, approval, initialRegion } = props;
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label={label}>
                                {getFieldDecorator('remark', {
                                    //initialValue: staffName
                                    rules: [{ required: true, message: "请输入", type: "string",max:300 }]
                                })(
                    ...
                    <Row gutter={8}>
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="转交说明">
                                {getFieldDecorator('remark', {
                                    //initialValue: staffName
                                    rules: [{ required: true, message: "请输入",type:"string",max:30 }]
                                })(
                                    <Input type="textarea" rows={10} />
                                    )}
                            </FormItem>
...
function PendingApprovalList({
    ...
    class BatchTransferApproval extends React.Component {
        ...
        render() {
            ...
            return (
                <span>
                    <Button onClick={this.showModal} disabled={!this.props.hasSelected}>批量转交</Button>
                    {(<NormalTransferApprovalForm
                        dispatch={this.props.dispatch}
                        ref={this.saveFormRef}
                        visible={this.state.visible}
    ...
    class BatchCommentApproval extends React.Component {
        ...
        render() {
            ...
            return (
                <span>
                    <Button onClick={this.showModal} disabled={!this.props.hasSelected}>{operate}</Button>
                    {(<NormalCommentApprovalForm
                        dispatch={this.props.dispatch}
                        ref={this.saveFormRef}
                        visible={this.state.visible}
