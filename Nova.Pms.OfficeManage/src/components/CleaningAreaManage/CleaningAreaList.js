...
const AddCleaningAreaForm = Form.create()(
    (props) => {
        const { visible, onCancel, onCreate, form, selectRegion, dispatch, regionList, staffList, cleaningArea, isAddOrEdit } = props;
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="区域代码" >
                                {getFieldDecorator('areaCode', {
                                    rules: [{ type: "string", max: 10, message: "请正确输入区域代码，最大长度为10" }]     
                        ...
                        <Col span={24}>
                            <FormItem  {...formItemLayout} label="区域名称">
                                {getFieldDecorator('areaName', {
                                    rules: [{ type: "string", required: isAddOrEdit, max: 20, message: "请正确输入区域名称，最大长度为20" }]
                                })(<Input disabled={!isAddOrEdit} />)}                          
                            </FormItem>
                        ...
                        <Col span={24}>
                            <FormItem  {...formItemLayout} label="备注">
                                {getFieldDecorator('remark', {
                                    rules: [{ type: "string", max: 100, message: "请正确输入备注，最大长度为100" }]   
                                })(<Input disabled={!isAddOrEdit} />)}
...
function CleaningAreaList({
    ...
    class AddCleaningArea extends React.Component {
        ...
        render() {           
            return (
                <span>
                    <Button type="primary" onClick={this.showModal} >新建区域</Button>
        ...
        render() {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    width: 70,
                    render: (text, record) => (
                        record.isOutsourced != null ? (record.isOutsourced == 0? "是":"否"):null
                    ),
                },
                {
                    title: "责任人",
                ...
                },
                {
                    ...
                    render: (text, record) =>
                        <span>
                            ...
                            />
                            &nbsp;                                                       
                            <Popconfirm title="确定要删除该保洁区域吗?" onConfirm={this.deleteCleaningArea.bind(null, [record.id])}>
                                <a >删除</a>
                            </Popconfirm>
                        </span>
                }
                    ...
                    <Row gutter={10} >
                            <Col span={8}>
                                ...
                                <AddCleaningArea
                                    ...
                                    cleaningArea={cleaningArea}
                                />
                                <Popconfirm title="确定要删除该保洁区域吗?" onConfirm={this.deleteCleaningArea.bind(this, selectedRowKeys)}>
