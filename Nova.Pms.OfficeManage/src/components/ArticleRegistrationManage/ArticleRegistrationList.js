...
const ArticleRegistrationForm = Form.create()(
    (props) => {
        const { visible, onCancel, onCreate, form, dispatch, regionList, userList, articleRegistration, handleQuantityValidate, isAddOrEdit, handleIdCardNoValidate, handlePhoneValidate } = props;
        ...
        return (
            <Modal
                ...
                <Form>
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="物品名称" >
                                {getFieldDecorator('name', {
                                    rules: [{ type: "string", required: isAddOrEdit, max: 50, message: "请正确输入物品名称，最大长度为50" }]     
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="数量" >
                                {getFieldDecorator('quantity', {
                                    rules: [{
                                        type: "string", required: isAddOrEdit, message: "请输入数量"},
                                        {
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="携带人" >
                                {getFieldDecorator('carryPerson', {
                                    rules: [{ type: "string", required: isAddOrEdit, max: 30, message: "请正确输入携带人,最大长度为30" }]
                                })(<Input disabled={!isAddOrEdit} />)}
                            </FormItem>
                        </Col>
                    </Row>
                    ...
                    <Row gutter={8}>
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="值班人员">
        ...
        render() {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    width: 180,
                    render: (text, record) => (
                        record.takeOutDate != null ? (new Date(record.takeOutDate)).toLocaleString() : null
                ...
                },
                {
                    ...
                    width: 180,
                    render: (text, record) => (
                        record.takeInDate != null ? (new Date(record.takeInDate)).toLocaleString() : null
                ...
                },
                {
                    ...
                    render: (text, record) =>
                        <span>
                            ...
                            />
                            &nbsp;                                                       
                            <Popconfirm title="确定要删除该物品出入登记吗?" onConfirm={this.deleteArticleRegistration.bind(null, [record.id])}>
                                <a >删除</a>
                            </Popconfirm>
                        </span>
                }
                ...
                <div className={styles.normal}>
                    ...
                    <Row gutter={10} >
                            <Col span={8}>
                                ...
                                />
                                <Popconfirm title="确定要删除该物品出入登记吗?" onConfirm={this.deleteArticleRegistration.bind(this, selectedRowKeys)}>
