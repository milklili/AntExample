...
const AddCleaningToolForm = Form.create()(
    (props) => { 
        
        const { visible, onCancel, onCreate, countValidate, handleHoursValidate, form, selectRegion, staffList,cleaningTool, regionList, departmentList, dispatch } = props;
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="入库日期" >
                                {getFieldDecorator('registerDate', {
                                    ...
                                    getValueProps: value => {
                                        if (!(value)) {
                                            cleaningTool.registerDate = moment(new Date(), 'YYYY-MM-DD');
                                        }
                                        return { value: value ? moment(value) : moment(new Date(), 'YYYY-MM-DD') };
                                    },
...
const ReceiveCleaningToolForm = Form.create()(
    (props) => {
            ...
            <Modal
                ...
                <Form>
                    <Row gutter={8}>
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="工具名称">
                                {getFieldDecorator('cleaningToolName', {
                                })(<Input disabled />)}
                            </FormItem>
                        </Col>
                    </Row>
...
const ReturnCleaningToolForm = Form.create()(
    (props) => {

        const { visible, onCancel, onCreate, countValidate, handleHoursValidate, form, selectRegion, staffList, cleaningToolItems, dispatch } = props;
...
function CleaningToolList({
    ...
    class AddCleaningTool extends React.Component {
        ...
        showModal = () => {
            ...
            var departmentList = this.props.departmentList.map(function (x) {
           ...
           // ids.push(this.props.rowData.id);
            return (
                <span>
                    ...
                    <Button type="primary" onClick={this.showModal} >工具登记</Button>
    ...
    class ReceiveCleaningTool extends React.Component {
        ...
        showModal = () => {
            ...
            var cleaningToolItems = { ...this.state.cleaningToolItems, ...{ cleaningToolId: this.props.cleaningTool.id },...{cleaningToolName:this.props.cleaningTool.name }
        };
            this.setState({
                staffList: staffList,
                cleaningToolItems: { ...this.state.cleaningToolItems, ...cleaningToolItems },
            });
            this.setState({ visible: true });
    ...
    class ReturnCleaningTool extends React.Component {
        ...
        showModal = () => {
            ...
            var cleaningToolItems = {
                ...this.state.cleaningToolItems, ...{ cleaningToolId: this.props.cleaningTool.id }, ...{ cleaningToolName: this.props.cleaningTool.name }
            };
            this.setState({
                staffList: staffList,
                cleaningToolItems: { ...this.state.cleaningToolItems, ...cleaningToolItems },
                ...
                
                {
                    ...
                    render: (text, record) =>
                        <span>
                            ...
                            />)}
                            &nbsp;
                             <Popconfirm title="确定要删除该保洁检查吗?" onConfirm={this.deleteCleaningTool.bind(this, [record.id])}>
                                <a>删除</a>
                            </Popconfirm>
                        </span>
                }
                ...
                <div className={styles.normal}>
                    ...
                    <Row gutter={10} >
                        <Col span={8}>
                                ...
                                <Popconfirm title="确定要删除该保洁检查吗?" onConfirm={this.deleteCleaningTool.bind(this, selectedRowKeys)}>
