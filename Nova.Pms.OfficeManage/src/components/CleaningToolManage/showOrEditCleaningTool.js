                            ...
                            <FormItem {...formItemLayout} label="领用日期" >
                                {getFieldDecorator('recipientsDate', {
                                    ...
                                    //}
                                     ...
                                     getValueProps: value => {
                                        if (!(value)) {
                                            cleaningToolItems.recipientsDate = moment(new Date(), 'YYYY-MM-DD');
                                        }
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="归还日期" >
                                {getFieldDecorator('returnDate', {
                                    ...
                                    getValueProps: value => {
                                        if (!(value)) {
                                            cleaningToolItems.returnDate = moment(new Date(), 'YYYY-MM-DD');
                                        }
                                        return { value: value ? moment(value) : moment(new Date(), 'YYYY-MM-DD') };
                                    }
                                })(<DatePicker style={{ width: '100%' }}
            ...
            const columns = [
                ...
                },
                {
                    ...
                    render: (text, record, index) => (
                        record.recipientsDate != null ? (new Date(record.recipientsDate)).toLocaleDateString() : null
                    )
                },
                ...
                },
                {
                    ...
                    width: 170,
                    render: (text, record, index) => (
                        record.returnDate != null ? (new Date(record.returnDate)).toLocaleDateString() : null
                    )
                },
                    ...
                    render: (text, record) =>
                        <span>
                            ...
                            {record.type == 1 &&
                                ...
                                />}
                            &nbsp;
                            <Popconfirm title="确定要删除该领用归还记录吗?" onConfirm={this.deleteCleaningToolItems.bind(null,record.id)}>
                                <a >删除</a>
                            </Popconfirm>
                            &nbsp;
                        </span>
