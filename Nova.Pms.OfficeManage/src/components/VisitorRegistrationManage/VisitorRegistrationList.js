...
const AddVisitorRegistrationForm = Form.create()(
    (props) => {
        const { visible, onCancel, onCreate, form, dispatch, regionList, visitorRegistration, isAddOrEdit, handleIdCardNoValidate, handlePhoneValidate } = props;
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="来访人姓名" >
                                {getFieldDecorator('name', {
                                    rules: [{ type: "string", required: isAddOrEdit, max: 10, message: "请正确输入来访人姓名，最大长度为10" }]     
                        ...
                        <Col span={24}>
                            <FormItem  {...formItemLayout} label="证件号码">
                                {getFieldDecorator('idCardNo', {                         
                                    rules: [{ required: isAddOrEdit, message: "请输入证件号码" },
                                        {
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="联系电话" >
                                {getFieldDecorator('phone', {
                                    rules: [{ required: isAddOrEdit, message: "请输入联系电话" },
                                        {
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="被访人" >
                                {getFieldDecorator('respondents', {
                                    rules: [{type:"string",max:30, required: isAddOrEdit, message: "请输入被访人,30字以内" }]
                                })(<Input disabled={!isAddOrEdit} />)}
                            </FormItem>
                        </Col>
                    </Row>
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="来访时间" >
                                {getFieldDecorator('visitDate', {
                                    ...
                                    getValueProps: value => {
                                        if (!(value)) {
                                            visitorRegistration.visitDate = moment(new Date(), 'YYYY-MM-DD HH:mm:ss');
                                        }
                    ...
                    <Row gutter={8}>
                        <Col span={24}>
                            <FormItem  {...formItemLayout} label="事由">
                                ...
                                <div style={{ color: "#ff8e48", display: (isAddOrEdit==false?"none":"block") }}>可输入汉字、大小写字母、数字、字符(最多80个汉字)</div>
                            </FormItem>                          
                        </Col>
                    </Row>
                </Form>
        ...
        render() {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    width: 180,
                    render: (text, record) => (
                        record.visitDate != null ? (new Date(record.visitDate)).toLocaleString() : null
                    ),
                },
                {
                    title: "离开时间",
                    ...
                    width: 180,
                    render: (text, record) => (
                        record.leaveDate != null ? (new Date(record.leaveDate)).toLocaleString() : null
                ...
                },
                {
                    ...
                    render: (text, record) =>
                        <span>
                            ...
                            />
                            &nbsp;                                                       
                            <Popconfirm title="确定要删除该来人来访记录吗?" onConfirm={this.deleteVisitorRegistration.bind(null, [record.id])}>
                                <a >删除</a>
                            </Popconfirm>
                        </span>
                }
                ...
                <div className={styles.normal}>
                    ...
                    <Row gutter={10} >
                            <Col span={8}>
                                ...
                                />
                                <Popconfirm title="确定要删除该来人来访登记吗?" onConfirm={this.deleteVisitorRegistration.bind(this, selectedRowKeys)}>
