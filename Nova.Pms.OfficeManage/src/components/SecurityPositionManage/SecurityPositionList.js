        ...
        render() {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    width: 150,
                     render: (text, record) => (
                         record.startDate != null ? (new Date(record.startDate)).toLocaleString() : null
...

                {
                    ...
                    render: (text, record) =>
                        <span>
                            <a onClick={this.showSecurityPosition.bind(null, record.id)}>查看</a>
                            &nbsp;
                            <a onClick={this.editSecurityPosition.bind(null, record.id, record.regionId)}>编辑</a>
                            &nbsp;
                             <Popconfirm title="确定要删除该保安岗记录吗?" onConfirm={this.deleteSecurityPosition.bind(null, record.id)}>
                                <a >删除</a>
                            </Popconfirm>
                        </span>
                }
            ...
            return (
                <div className={styles.normal}>
                    ...
                    <Row gutter={10} >
                            <Col span={8}>
                                <Button type="primary" onClick={this.addSecurityPosition.bind(null, null)}>新建保安岗</Button>
