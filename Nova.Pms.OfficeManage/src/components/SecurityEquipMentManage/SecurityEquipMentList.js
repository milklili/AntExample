...
const AddSecurityEquipMentForm = Form.create()(
    (props) => {
        const { visible, onCancel, onCreate, handleNumberValidate, selectRegion, form, dispatch, regionList, departmentList, staffList, securityEquipMent, isAddOrEdit, handleIdCardNoValidate, handlePhoneValidate } = props;
        ...
        const isSelectRegion = securityEquipMent.regionId != null && securityEquipMent.regionId > 0;
        return (
            <Modal
                visible={visible}
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="名称" placeholder="请输入">
                                {getFieldDecorator('name', {
                                    rules: [{ required: true,type:"string",max:30, message: '请输入名称,不超过30个字' }],
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="地点/区域">
                                {getFieldDecorator('place', {
                                    ...
                                    rules: [{ required: true, type: "string", max: 30, message: '请输入地点/区域，不超过30个字' }],
                                })(<Input disabled={!isAddOrEdit}/>)}
                            </FormItem>
                        </Col>
                    </Row>
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="规格型号">
                                {getFieldDecorator('specificationModel', {
                                    //initialValue: securityEquipMent.name,
                                    rules: [{ required: true, type: "string", max: 20, message: '请输入规格型号，不超过20个字' }],
                                })(<Input disabled={!isAddOrEdit}/>)}
                            </FormItem>
                        </Col>
                    </Row>
                        ...
                        <Col span={24}>
                            <FormItem {...formItemLayout} label="备注">
                                {getFieldDecorator('remark', {
                                    rules: [{ required: false, type: "string", max: 80, message: '请输入地点/区域，不超过80个字' }],
                                })(<Input disabled={!isAddOrEdit}/>)}
                            </FormItem>
                        </Col>
                    </Row>
    ...
    class AddSecurityEquipMent extends React.Component {
       ...
       handleNumberValidate = (rule, value, callback) => {
        ...
        render() {           
            return (
                <span>
                    <Button type="primary" onClick={this.showModal} >器材登记</Button>
        ...
        showModal = (e) => {
            ...
            this.setState({
                ...
                securityEquipMent: {
                    ...
                    responsibilityPersonId: this.props.securityEquipMent.responsibilityPersonId,
                    responsibilityPersonName: this.props.securityEquipMent.responsibilityPersonName,
                ...
                },
                {
                    ...
                    render: (text, record) => (
                        ...
                        <span>
                            ...
                            />
                            &nbsp;
                            <Popconfirm title="确定要删除该安保器材吗?" onConfirm={this.deleteSecurityEquipMent.bind(null, [record.id])}>
                                <a >删除</a>
                            </Popconfirm>
                        </span>
                    )
                    ...
                    <Row gutter={10} >
                            <Col span={8}>
                                ...
                                <AddSecurityEquipMent
                                    ...
                                    securityEquipMent={securityEquipMent}
                                />
                                <Popconfirm title="确定要删除该安保器材吗?" onConfirm={this.deleteSecurityEquipMent.bind(this, selectedRowKeys)}>
