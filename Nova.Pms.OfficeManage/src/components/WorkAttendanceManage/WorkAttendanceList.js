...
const AddStaffForm = Form.create()(
    (props) => {
        const { visible, onCancel, onCreate, form, workAttendance, handleNameValidate, handleIdCardNoValidate, handlePhoneValidate} = props;
        const { getFieldDecorator } = form;
        const formItemLayout = {
            labelCol: { span: 6 },
            wrapperCol: { span: 18 },
                        ...
                        <Col span={12}>
                            <FormItem {...formItemLayout} label="姓名">
                                {getFieldDecorator("name", {
                                    rules: [{ required: true, message: "请输入姓名，长度不超过255",type:"string",max:255 },
                                        {
