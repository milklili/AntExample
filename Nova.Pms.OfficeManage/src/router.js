...

        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/cleaningAreaManage/cleaningAreaList')
              )
        ...
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/cleaningRecordManage/cleaningRecordList')
              )
              cb(
                null,
                require('./routes/cleaningRecordManage/cleaningRecordList')
              )
            })
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/cleaningInspectManage/cleaningInspectList')
              )
              cb(
                null,
                require('./routes/cleaningInspectManage/cleaningInspectList')
              )
            })
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/cleaningToolManage/cleaningToolList')
              )
        ...
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/cleaningToolManage/showOrEditCleaningTool')
              )
              cb(
                null,
                require('./routes/cleaningToolManage/showOrEditCleaningTool')
              )
            })
          },
        },

        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/approvalManage/createApproval')
              )
        ...
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/approvalManage/initiatedList')
              )
        ...
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/pendingApprovalManage/pendingApprovalList')
              )
              cb(
                null,
                require('./routes/pendingApprovalManage/pendingApprovalList')
              )
            })
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/pendingApprovalManage/approvedList')
              )
...

        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/pendingApprovalManage/sendApprovalList')
              )
              cb(
                null,
                require('./routes/pendingApprovalManage/sendApprovalList')
              )
            })
          },
        },
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(
                app,
                require('./models/approvalManage/showApproval')
              )
