...
export function getData (pageInfo) {
  ...
  return request(
    `/api/officeManage/securityPosition/securityPositionList?${params}`,
    {
      method: 'GET',
    }
  )
...
export function getSecurityDutyPlanList ({ regionId }) {
  return request(
    `/api/officeManage/securityPosition/securityDutyPlanList?RegionId=${regionId}`
  )
}

export function getSecurityPositionInformation ({ id }) {
  return request(
    `/api/officeManage/securityPosition/securityPositionInformation/${id}`
  )
}
export function getDetailSecurityPositionList ({ id }) {
  return request(
    `/api/officeManage/securityPosition/detailSecurityPositionList/${id}`
  )
}

export function save (securityPosition, update) {
...
export function getSecurityDutyPlanData ({ securityDutyPlanId }) {
  return request(
    `/api/officeManage/securityPosition/securityDutyPlanData/${securityDutyPlanId}`
  )
}
...
export function removeSecurityPositionMembers ({ id }) {
  return request(
    `/api/officeManage/securityPosition/securityPositionMembers/${id}`,
    {
      headers: {
        'Content-Type': 'application/json',
      },
